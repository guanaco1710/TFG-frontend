...
class _HomeShell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget gymPlansProviderBuilder(gym) => ChangeNotifierProvider(
    ...
    Widget gymListScreenBuilder() => ChangeNotifierProvider(
      ...
      child: GymListScreen(gymPlansProviderBuilder: gymPlansProviderBuilder),
    );
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    MaterialPageRoute(
                      builder: (_) => ChangeNotifierProvider(
                        ...
                        child: MySubscriptionScreen(
                          gymListScreenBuilder: gymListScreenBuilder,
                        ),
                      ),
                    ),
                  ),
                ...
                FilledButton(
                  onPressed: () => Navigator.of(context).push(
                    MaterialPageRoute(builder: (_) => gymListScreenBuilder()),
                  ),
                  style: FilledButton.styleFrom(
                    padding: const EdgeInsets.symmetric(vertical: 20),
                    textStyle: const TextStyle(
